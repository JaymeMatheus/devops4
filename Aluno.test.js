...
describe('Testes da classe Aluno', () => {
  ...
  test('calcularMencao deve retornar SS para média >= 9', () => {
  ...
  test('calcularMencao deve retornar MM para média >= 5 e < 7', () => {
  ...
  test('calcularMencao deve retornar MI para média < 5', () => {
